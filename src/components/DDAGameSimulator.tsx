...
export const DDAGameSimulator: React.FC<DDAGameSimulatorProps> = ({
  ...
  }, [currentScenarioIndex, currentTier, userSettings.timerMode]);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-stone-200 pb-5">
        <div>
          ...
          <p className="text-xs text-stone-600 mt-1 max-w-2xl leading-relaxed">
            Face realistic educational tensions. The system continuously measures your somatic pause quality, response accuracy, and latency, dynamically tuning scenario difficulty to keep you in the optimal flow channel.
          </p>
        </div>
